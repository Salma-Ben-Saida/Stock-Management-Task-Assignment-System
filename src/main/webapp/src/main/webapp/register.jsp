...
<head>
  ...
  <title> Register - TransLogistics</title>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Entrez vos détails personelles pour Créer un nouveau compte</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Entrez une adresse Email Valide s'il vous plait !</div>
                    </div>

                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Nom Utilsateur</label>
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">@</span>
                        <input type="text" name="username" class="form-control" id="yourUsername" required>
                        <div class="invalid-feedback">Choisissez un nom Utilsateur</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Vous avez déjà un compte ?<a href="login.html">Se connecter</a></p>
                    </div>
                  </form>
