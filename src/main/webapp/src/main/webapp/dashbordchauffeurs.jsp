...
<head>
  ...
  <title>Dashboard - TransLogistics-Chauffeurs</title>
        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="card recent-sales overflow-auto">
              ...
              <div class="card-body">
                <h5 class="card-title">Chauffeurs <span>| TransLogitcs</span></h5>
                ...
                <table class="table table-borderless datatable">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="inscriptionchauffeur.jsp" class="btn btn-light btn-sm"><i class="bi bi-pencil-square text-primary"></i></a>
                        <a href="inscriptionchauffeur.jsp" class="btn btn-light btn-sm"><i class="bi bi-plus-circle text-success"></i></a>
