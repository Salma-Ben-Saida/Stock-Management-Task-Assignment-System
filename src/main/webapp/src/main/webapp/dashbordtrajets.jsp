...
<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="affecterChauffeur.jsp">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Liste Des Trajets Planifiés</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="card recent-sales overflow-auto">
              ...
              <div class="card-body">
                <h5 class="card-title">Trajets Planifiés <span>| TransLogitcs</span></h5>
      
                <table class="table table-borderless datatable">
                  <thead>
                    <tr>
                      <th scope="col">idTrajet</th>
                      <th scope="col">idChauffeur</th>
                      <th scope="col">idVéhicule</th>
                      <th scope="col">Destination</th>
                      <th scope="col">Date</th>
                      <th scope="col">statut</th>
                      <th scope="col">DateDébut</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="planifiertrajet.jsp" class="btn btn-light btn-sm"><i class="bi bi-pencil-square text-primary"></i></a>
                        <a href="planifiertrajet.jsp" class="btn btn-light btn-sm"><i class="bi bi-plus-circle text-success"></i></a>
